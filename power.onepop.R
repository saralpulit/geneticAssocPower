...
ccPowerMultiPopBigLoop <- function(afceu, afpop2)
{
        ...
        results.flip.F <- ccPowerMultiPop( grr, 1e-8, afceu, afpop2, F )
        results.flip.T <- ccPowerMultiPop( grr, 1e-8, afceu, afpop2, T )
...
outputfile <- paste("power.80K.", letter, ".", pop2, ".", grr, ".txt", sep="")
